...
<script
	...
	background="${pageContext.request.contextPath}/image/back4.jpg" style=" background-repeat:no-repeat ;
background-size:100% 100%;
background-attachment: fixed;">
	<div style="margin-top:30px ">
	<div style="margin-left:510px "><span style="color:white;font-size:30px;">✧ 注册 ✧</span></div>
<div class="container" style="margin-left:200px;">
	<div class="row clearfix">
		<div class="col-md-8 column">
			<form class="form-horizontal" role="form" >
				...
				<div class="form-group">
					 <label class="col-sm-2 control-label" for="inputPassword3"><span style="color:white;font-size:20px;">性别：</span></label>
					<div class="col-sm-8">
						...
						<input   type="radio" name="sex" value="0" /><span style="color:white;">女</span>
								...
								<div class="form-group">
					 <label class="col-sm-2 control-label" for="inputEmail3"><span style="color:white;font-size:20px;">年龄:</span></label>
					<div class="col-sm-8">
						<input class="form-control" id="id" type="number" id="id"/>
					</div>
				</div>
				<div class="form-group">
					...
					<button type="button" class="btn btn-default" onclick="testRegist()">注册</button>
					</div>
				</div>
			</form>
		</div>
	...
	<a href="${pageContext.request.contextPath}/loginView.do" style="color:white; margin-left:500px;">已有账号？->登录 </a>
	</body>
